...
bemis!recipe::crafting[minecraft:piston]

bemis!recipe::crafting[minecraft:flint_and_steel]

bemis!recipe::crafting[minecraft:white_wool_from_string]
